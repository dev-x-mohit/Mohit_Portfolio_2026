...
export const skillCategories: SkillCategory[] = [
    {
        ...
        skills: [
            ...
            { name: "Next.js", icon: <SiNextdotjs className="text-black dark:text-white" />, level: 90, angle: 36, radius: { mobile: 15, tablet: 16, desktop: 17 } },
            { name: "TypeScript", icon: <FaCode color="#3178C6" />, level: 88, angle: 72, radius: { mobile: 16, tablet: 18, desktop: 19 } },
            { name: "JavaScript", icon: <FaJs color="#F7DF1E" />, level: 95, angle: 108, radius: { mobile: 19, tablet: 21, desktop: 23 } },
            { name: "Tailwind", icon: <SiTailwindcss color="#06B6D4" />, level: 90, angle: 144, radius: { mobile: 16, tablet: 18, desktop: 19 } },
            { name: "HTML5", icon: <FaHtml5 color="#E34F26" />, level: 95, angle: 180, radius: { mobile: 18, tablet: 20, desktop: 21 } },
            { name: "CSS3", icon: <FaCss3Alt color="#1572B6" />, level: 90, angle: 216, radius: { mobile: 15, tablet: 17, desktop: 18 } },
            { name: "SASS", icon: <FaCss3Alt color="#CC6699" />, level: 85, angle: 252, radius: { mobile: 14, tablet: 15, desktop: 16 } },
            { name: "Bootstrap", icon: <SiBootstrap color="#7952B3" />, level: 85, angle: 288, radius: { mobile: 14, tablet: 15, desktop: 16 } },
            { name: "Vite", icon: <SiVite color="#646CFF" />, level: 80, angle: 324, radius: { mobile: 13, tablet: 14, desktop: 15 } },
        ]
    },
    {
        name: "Backend",
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Docker", icon: <FaDocker color="#2496ED" />, level: 75, angle: 88, radius: { mobile: 14, tablet: 15, desktop: 16 } },
            { name: "Kubernetes", icon: <FaServer color="#326CE5" />, level: 70, angle: 110, radius: { mobile: 13, tablet: 14, desktop: 15 } },
