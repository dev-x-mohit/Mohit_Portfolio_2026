'use client';
import { Search, Settings, Star, Download, Box, Github, Npm, Html5, Css3, Code } from 'iconoir-react';
...
const EXTENSIONS = [
    ...
    { id: 'react-native', name: 'React Native', author: 'facebook', downloads: '1B+', description: 'Framework for building native apps using React', icon: <Code className="text-[#61DAFB]" /> },
                        ...
                        <div key={ext.id} className="px-4 py-2.5 hover:bg-[var(--ide-bg-panel)] cursor-pointer flex gap-3 group border-l-2 border-transparent hover:border-[var(--ide-accent)] transition-colors">
                            ...
                            <div className="flex-1 min-w-0 flex flex-col justify-center">
                                ...
                                <div className="flex items-center gap-3 mt-1.5 text-[9px] text-[var(--ide-fg-secondary)] opacity-60">
                                    ...
                                    <span className="flex items-center gap-0.5"><Download width={8} height={8} /> {ext.downloads}</span>
                                </div>
                            </div>
                        </div>
                    ))}
